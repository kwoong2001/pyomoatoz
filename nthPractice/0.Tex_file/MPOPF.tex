...
\begin{frame}
	...
	If a line has a charging susceptance, the model must consider the impact of susceptance($- \sum_{\forall j }B_{ij,t} \left\lvert \dot{V}_{i,t}\right\rvert^{2}$).
	\begin{align}
	\label{eq:cons_load_bal_Q}
		Q_{G_{i,t}} - Q_{D_{i,t}} = \sum_{j \in \Omega_{b_{i}}}(Q_{ij,t}) - \sum_{\forall j }B_{ij,t} \left\lvert \dot{V}_{i,t}\right\rvert^{2}  \quad \forall i \in \Omega_{b} ,\ \forall t \in T
	\end{align}
