...
# 출력 그림 선택 1=그림 저장, 0=저장 안함
Tree_layout = 1
Tree_layout_Netload = 0
Tree_layout_Vmag = 0
Tree_layout_P_PowerFlow = 0
Tree_layout_Q_PowerFlow = 0
Gen_P_stacked = 0
Gen_P = 0
Load_P = 0 
Load_Q = 0
P_line_flow_sending_fig = 0
V_mag_fig = 0
V_ang_fig = 0
...
OUT_PNG_NL = os.path.join(output_fig_directory, f"Tree_layout_Netload_at_{TIME_INDEX}h.png")
OUT_PNG_V = os.path.join(output_fig_directory, f"Tree_layout_Vmag_at_{TIME_INDEX}h.png")
OUT_PNG_P_PF = os.path.join(output_fig_directory, f"Tree_layout_P_PowerFlow_at_{TIME_INDEX}h.png")
OUT_PNG_Q_PF = os.path.join(output_fig_directory, f"Tree_layout_Q_PowerFlow_at_{TIME_INDEX}h.png")
