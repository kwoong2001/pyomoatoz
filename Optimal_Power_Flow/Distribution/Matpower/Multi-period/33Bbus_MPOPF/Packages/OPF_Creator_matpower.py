...
def OPF_model_creator_with_switch(np,pyo,base_MVA,Slackbus,Bus_info,Line_info,Load_info,Gen_info,Time_info):
    ...
    model.Line_Status = pyo.Var(model.Lines, model.Times, within=pyo.Integers, bounds=(0, 1),initialize = 0)
